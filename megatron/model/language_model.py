            ...
            for key in state_dict.keys():
                if 'word_embeddings' in key:
                    state_dict_[key.split('word_embeddings.')[1]] \
                        = state_dict[key]
        if state_dict_['weight'].shape[0] == 125952: 
            state_dict_['weight'] = state_dict_['weight'][:125696,...]
    ...
    def load_state_dict(self, state_dict, strict=True):
        ...
        if self.post_process:
            ...
            if self.untie_embeddings_and_output_weights:
                ...
                if state_dict[self._output_layer_key]['weight'].shape[0] == 125952: 
                           state_dict[self._output_layer_key]['weight'] = state_dict[self._output_layer_key]['weight'][:125696,...]
